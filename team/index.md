...
%}
 ...
 <!-- Name & Role -->
  <div class="text-center" style="margin-top:0px; font-weight: var(--bold); font-size: 1.1rem" > Jie Chen
  <div class="text-center" style="margin-top: -10px"> Assistant Professor 
